...
export default function Footer() {
    ...
    return (
        <footer className="relative z-10 bg-brand-darkbrown border-t border-white/5 pt-20 pb-10 overflow-hidden">
            <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 w-160 h-160 bg-brand-red/5 blur-[120px] rounded-full pointer-events-none z-0" />
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <Link href="/" className="inline-block group">
                            <img
                                src={myLogo}
                                alt="Titik Koma Logo"
                                className="w-32 h-auto grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-500"
                            />
                        </Link>
                        ...
                        <div className="flex gap-3 pt-2">
                            {[
                                ...
                                <a
                                    ...
                                    className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:bg-brand-yellow hover:text-brand-darkbrown hover:border-brand-yellow hover:-translate-y-1 transition-all duration-300"
                    ...
                    <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-8 lg:pl-12">
                        <div className="space-y-5">
                            ...
                            <ul className="space-y-3 text-gray-400 font-bold uppercase text-[10px] tracking-widest">
                                ...
                                <li><Link href="/portfolio" className="hover:text-white hover:pl-1 transition-all">Portfolio</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="space-y-5 col-span-2 md:col-span-1">
                            ...
                            <ul className="space-y-3 text-gray-400 text-sm font-medium">
                                ...
                                <li className="flex items-center gap-2 hover:text-white transition-colors cursor-pointer group">
                                    <Phone size={14} className="text-brand-yellow group-hover:scale-110 transition-transform" />
